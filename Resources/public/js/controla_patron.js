...
function validaPatron(e, patron) {
    ...
    // Teclas de retroceso para borrar, tab, enter, delete, flecha izquierda y derecha, siempre la permite
    if (tecla==8 || tecla==13) {
        return true;
    } else if (e.keyCode==9 || e.keyCode==46 || e.keyCode==37 || e.keyCode==39) {
        return true;
    }
